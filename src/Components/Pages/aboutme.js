            ...
            <Cell className="name__container" col={6}>
              <BouncyDivRight> <h2> Technology Summary </h2>
                <div className="name__container-content">
                  <p><span className="skillset">Programming Languages Skills: </span> JavaScript, React Js, Redux, Web-components, SPA, jQuery, CSS3, Sass, HTML5,BootStrap4, WordPress and knowledge of Node JS, Express and Mongo DB</p>
