...
import capstoneProjectsdetails from '../Assests/capstoneProjectsdetails';
...
const CapstoneProjects = () => {
  return (
    ...
    {capstoneProjectsdetails.map(details => {
      return (
        <Zoom duration={500} key={details.id}>
          <Container className="card Project-card" key={details.id} style={{ padding: "2em", marginTop: "2em", backgroundColor: "#9acd32", borderRadius: "15px", boxShadow:"rgba(0, 0, 0, 0.2) 0.5rem 0.5rem 2rem 0px", fontFamily: "'oxygen', sansSerif" }}>
